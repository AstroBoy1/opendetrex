...
VOC_COCO_CLASS_NAMES["TOWOD"] = tuple(itertools.chain(VOC_CLASS_NAMES))
VOC_COCO_CLASS_NAMES["TOWOD_t2"] = tuple(itertools.chain(VOC_CLASS_NAMES, T2_CLASS_NAMES))
...
register_pascal_voc("towod_t2", dir, "owod_t2_train_andexemplars", 2007, VOC_COCO_CLASS_NAMES["TOWOD_t2"])
