...
# This program takes in the t1_tpfp_scores and calculates the
# thresholds for pseudolabels
...
def main():
    ...
    fn = "threshold_files/t1_known_tpfp_scores.csv"
    df = pd.read_csv(fn)
    class_threshold_df = pd.DataFrame()
    class_list = []
    thresh_list = []
    save_output = True
    out_fn = "threshold_files/t1_known50_class_f1_thresholds.csv"
    class_names = VOC_COCO_CLASS_NAMES["TOWOD"]
    fn, out_fn, split = args[0], args[1], args[2]
    print(fn, out_fn)

    cc, num_files, class_files = load_voc_instances(dirname="/nfs/hpc/share/omorim/projects/PROB/data/VOC2007", split=split,
